...
import (
	...
	"github.com/GodSlave/MyGoServer/utils/x/crypto/acme"
	"github.com/GodSlave/MyGoServer/utils/x/net/context"
)
...
func (m *Manager) GetCertificate(hello *tls.ClientHelloInfo) (*tls.Certificate, error) {
	...
	// regular domain
	name = strings.TrimSuffix(name, ".") // github.com/GodSlave/MyGoServer/utils/issue/18114
