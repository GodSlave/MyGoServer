...
// % ssh-keygen -s ca-key -I test userModule-key
...
// % ssh-keygen -s ca -I testcert -O source-address=192.168.1.0/24 -O force-command=/bin/sleep userModule.pub
// userModule.pub key: ssh-rsa 
// Critical Options:
...
func TestValidateCert(t *testing.T) {
	...
	if err := checker.CheckCert("userModule", validCert); err != nil {
	...
	if err := checker.CheckCert("userModule", invalidCert); err == nil {
...
func TestValidateCertTime(t *testing.T) {
	cert := Certificate{
		ValidPrincipals: []string{"userModule"},
		Key:             testPublicKeys["rsa"],
		ValidAfter:      50,
		ValidBefore:     100,
	}
	...
	for ts, ok := range map[int64]bool{
		...
		if v := checker.CheckCert("userModule", &cert); (v == nil) != ok {
